...
/**
 * Uncomment this block and reload spaceswars once to reset all data
 *
 for (var i = 0; i < 18; i++)for (i = 0; i < 19; i++) {
     try {
         GM_deleteValue("fleet_points_uni_" + i);
     } catch (ex) {
         console.log("No fleet points for uni " + i);
     }

     try {
         GM_deleteValue("config_scripts_uni_" + i);
     } catch (ex) {
         console.log("No config script for uni " + i);
     }

     try {
         GM_deleteValue("galaxy_data_" + i);
     } catch (ex) {
         console.log("No galaxy data for uni " + i);
     }
     ...
     try {
         GM_deleteValue("markit_data_" + i);
     } catch (ex) {
         console.log("No markit data for uni " + i);
     }
 }
 ...
 try {
    ...
    console.log("No infos_scripts");
}

 try {
    GM_deleteValue("infos_version");
} catch (ex) {
    console.log("No infos_version");
}

 try {
    GM_deleteValue("fp_redirect");
} catch (ex) {
    console.log("No redirect");
}

 try {
    GM_deleteValue("InactiveList");
} catch (ex) {
    console.log("No Inactive List");
}

 try {
    GM_deleteValue("ResourceRedirect");
} catch (ex) {
    console.log("No Resource Redirect");
}

 try {
    GM_deleteValue("ResourceRedirectType");
} catch (ex) {
    console.log("No Resource Redirect Type");
}
 return;
 */
